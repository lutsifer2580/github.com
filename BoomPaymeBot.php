...
ob_start();
define("uzfox","1416315427:AAHA6RBoFLm-6Ysd1ACfJCrnJO6vkpbLziY");
$admin = "1466475810";
$botname = "jdjjdndbot";
...
"inline_keyboard"=>[
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/joinchat/SAkAmD2NLqUNJyHh"],],
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/joinchat/RnoDXBihvaERngkN"],],
[["text"=>"➕ A‘zo bo‘lish","url"=>""https://t.me/joinchat/TPaWZr9i1je3-Dl7"],],
...
"parse_mode"=>"markdown",
       ...
       uzfox("sendMessage",[
              ...
              "parse_mode"=>"html",
               "reply_markup"=>json_encode([   
   "inline_keyboard"=>[
[["text"=>"👨‍💻 Admin","url"=>"https://telegram.me/Kotta_Dasturchi"],["text"=>"👥 Kanalimiz","url"=>"https://t.me/OLX_OZBEKISTONDA"],],
]
]),
]);
}
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"🗣 Bog'lanish","url"=>"https://t.me/Kotta_Dasturchi"],],
]
]),
]);
}
